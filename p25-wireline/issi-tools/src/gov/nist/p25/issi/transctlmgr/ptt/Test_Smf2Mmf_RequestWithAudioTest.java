...
/**
 * Tests sending and receiving audio in a PTT Request.
 */
public class Test_Smf2Mmf_RequestWithAudioTest extends TestCase 
   ...
   public void test() {
      ...
      System.out.println("=============================================\n"
            + "File: Smf2Mmf_RequestWithAudioTest\n"
            + "Description: Tests sending and receiving audio in a PTT Request:\n"
            + "Reference: Section 7\n\n" +

            "SMF -> PTT TRANSMIT REQUEST with AUDIO -> MMF\n"
            + "SMF <- PTT TRANSMIT GRANT <- MMF\n"
            + "SMF -> PTT PROGRESS -> MMF (audio packets)\n"
      ...
      try {
         ...
         smfSession.smfTransmitter.sendSpurtRequestWithVoice(imbeVoiceBlocks, 3,0);
   ...
   public void tearDown() throws Exception {
      ...
      assertTrue(gotRequestWithVoice == true);
