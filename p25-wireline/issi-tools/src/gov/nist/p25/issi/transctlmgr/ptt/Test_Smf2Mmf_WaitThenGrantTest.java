 ...
 */
public class Test_Smf2Mmf_WaitThenGrantTest extends TestCase 
   ...
   public void test() {
      ...
      try {
         ...
         mmfSession.getMmfReceiver().setArbitrateWaitThenGrant(5000);
