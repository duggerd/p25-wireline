 ...
 */
public class Test_Smf2Mmf_ForceAudioTest extends TestCase
   ...
   public void test() {
      ...
      System.out.println("=============================================\n"
            + "File: Test_SmfTx_ForcedAudioSend\n"
            + "Description: SMF self-grant transmit to MMF with no"
            + " PTT TRANSMIT REQUEST:\n"
            + "Reference: Section 7.2.1-7.2.2\n\n" +

            "SMF -> PTT TRANSMIT PROGRESS -> MMF (x3 audio packets)\n"
      ...
      try {
         ...
         smfSession.smfTransmitter.forceAudio(imbeVoiceBlocks, 3, 0, imbeVoiceBlocks.size());
