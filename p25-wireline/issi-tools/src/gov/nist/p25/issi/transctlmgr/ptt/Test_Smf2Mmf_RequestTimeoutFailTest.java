 ...
 */
public class Test_Smf2Mmf_RequestTimeoutFailTest extends TestCase
   ...
   public void test() {
      ...
      System.out.println("=============================================\n"
            + "File: Test_SmfTx_RequestTimeout_FailOnTimeout"
            + "Description: Tests SMF Tx request timeout w/ Fail on timeout.  "
            + "Note that an MmfApplication is not started to facilitate "
            + "request timeout:\n" + "Reference: Section 7.2.1\n\n" +
            "SMF -> PTT REQUEST-> NO MMF (x4)\n"
            + "SMF LOCAL_POLICY\n" + "SMF FAIL_ON_TIMEOUT\n"
      ...
      try {
         ...
         smfSession.smfTransmitter.setFailOnRqstTimeout();
   ...
   public void tearDown() throws Exception {
      ...
      assertTrue(requestTimeout == true);
