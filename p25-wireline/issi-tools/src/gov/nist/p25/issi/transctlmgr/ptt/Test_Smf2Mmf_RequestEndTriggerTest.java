 ...
 */
public class Test_Smf2Mmf_RequestEndTriggerTest extends TestCase
   ...
   public void test() {
      ...
      System.out.println("=============================================\n"
            + "File: Test_SmfTx_RequestEndTrigger\n"
            + "Description: Tests end trigger of SMF request.\n"
            + "Reference: Section 7.2.1\n\n" +

            "SMF -> PTT TRANSMIT REQUEST -> NO MMF\n" + "SMF END TRIGGER\n"
            + "SMF -> PTT TRANSMIT END -> NO MMF\n" + "SMF TERMINATED\n"
            + "---------------------------------------------");
      ...
      try {
         ...
         smfSession.smfTransmitter.setRqstEndTrigger();
