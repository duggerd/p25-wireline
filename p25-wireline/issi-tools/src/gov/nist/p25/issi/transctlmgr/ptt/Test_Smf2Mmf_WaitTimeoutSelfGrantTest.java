 ...
 */
public class Test_Smf2Mmf_WaitTimeoutSelfGrantTest extends TestCase
   ...
   public void test() {
      ...
      try {
         ...
         smfSession.smfTransmitter.setWaitUnstoppableTrigger();
         ...
         mmfSession.getMmfReceiver().setArbitrateWaitThenGrant(8000);
   ...
   public void tearDown() throws Exception {
      ...
      assertTrue(gotWait == true);
      assertTrue(requestTimeout == false);
      assertTrue(waitTimeout == true);
