...
//	private static String HIDDEN_FILE = "Hidden File";
	 ...
	 * @see #addExtension
	 */
	public TraceFileFilter(String extension) {
		this(extension, null);
	}
	 ...
	 * @see #addExtension
	 */
	public TraceFileFilter(String extension, String description) {
		this();
		if (extension != null)
	 ...
	 * @see #addExtension
	 */
	public TraceFileFilter(String[] filters) {
		this(filters, null);
	}
	 ...
	 * @see #addExtension
	 */
	public TraceFileFilter(String[] filters, String description) {
		this();
